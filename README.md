...
Whenever a new user tries to talk with the bot, admins are notified. They can add the new user, and if they later decide to remove the user there's a ban button.
